...
#define CS_LOW()	PORTB &= 0xfe			/* CS=low */
...
void power_on (void)
{
	...
	//PORTB |= 0b00001101;	/* Configure SCK/MOSI/CS as output */
	//DDRB = 0xf7;
...
void power_off (void)
{
	SPCR = 1;				/* Disable SPI function */

//	DDRB =	0xf7;	/* Set SCK/MOSI/CS as hi-z, INS#/WP as pull-up */
//	PORTB &= ~0b00000111;
//	PORTB |=  0b00000000;
